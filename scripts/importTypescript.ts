//taken from https://github.com/microsoft/monaco-editor/blob/main/build/importTypescript.ts
...
const generatedNote = `//
// **NOTE**: Do not edit directly! This file is generated using \`npm run import-ts\`
//
`;
...
const TYPESCRIPT_LIB_DESTINATION = path.join(REPO_ROOT, "ts");
...
export var ModuleKind = ts.ModuleKind;
// END MONACOCHANGE
`;
    fs.writeFileSync(
